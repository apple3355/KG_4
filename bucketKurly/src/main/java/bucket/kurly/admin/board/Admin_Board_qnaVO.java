...
public class Admin_Board_qnaVO {
	...
	public String toString() {
		return "Admin_Board_qnaVO [board_qna_no=" + board_qna_no + ", board_qna_type=" + board_qna_type
				+ ", board_qna_title=" + board_qna_title + ", board_qna_regdate=" + board_qna_regdate
				+ ", board_qna_order_no=" + board_qna_order_no + ", board_qna_member_no=" + board_qna_member_no
				+ ", board_qna_writer=" + board_qna_writer + ", board_qna_email=" + board_qna_email
				+ ", board_qna_phone=" + board_qna_phone + ", board_qna_content=" + board_qna_content
				+ ", board_qna_group=" + board_qna_group + ", board_qna_gstep=" + board_qna_gstep + "]";
	}
