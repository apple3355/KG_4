...
public class Goods_adminSellVO {
	...
	private String goods_sell_goods_no;
	...
	public String getGoods_sell_goods_no() {
		return goods_sell_goods_no;
	}
	public void setGoods_sell_goods_no(String goods_sell_goods_no) {
		this.goods_sell_goods_no = goods_sell_goods_no;
	}
	...
	public String toString() {
		return "Goods_adminSellVO [goods_sell_no=" + goods_sell_no + ", goods_sell_parent_no=" + goods_sell_parent_no
