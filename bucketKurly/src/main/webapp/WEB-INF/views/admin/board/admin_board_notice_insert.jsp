                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <h4 class="" style="color: #6406ca; font-weight: bolder; float: left; margin-top:10px;" >공지사항 등록</h4>
                        </div>
                        <div class="card-body">
                            <form role="form" id="form" action="${pageContext.request.contextPath}/admin_board_notice_insertDB.mdo">
                                <input type="hidden" name="board_notice_writer" value="bucketkurly">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										<tr>
											<th width="20%">작성일</th><td width="70%"><%= sf.format(nowTime) %></td>
										</tr>
										<tr>
											<th width="20%">제목</th><td width="70%"><input class="form-control" name ="board_notice_title"></td>
										</tr>
										<tr>
											<th width="20%">내용</th><td width="70%"><textarea class="form-control" rows="40" id ="board_notice_content" name="board_notice_content"></textarea></td>
										</tr>
                                </table>
							</form>
                        </div>
