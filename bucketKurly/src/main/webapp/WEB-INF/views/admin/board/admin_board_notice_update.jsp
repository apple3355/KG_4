                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                    	<div class="card-header">
                            <h4 class="" style="color: #6406ca; font-weight: bolder; float: left; margin-top:10px;" >공지사항 수정</h4>
                        </div>
                        <div class="card-body">
                            <form role="form" id ="form" action="${pageContext.request.contextPath}/admin_board_notice_updateDB.mdo">
