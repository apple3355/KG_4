                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <h4 class="" style="color: #6406ca; font-weight: bolder; float: left; margin-top:10px;" >상위 카테고리 등록</h4>
                        </div>
                        
                        <div class="card-body">
                            <form method="post" id="form" role="form" action="${pageContext.request.contextPath}/admin_category_parent_insertDB.mdo" enctype="multipart/form-data">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="vertical-align:middle; text-align:center;">
                                      	<tr>
