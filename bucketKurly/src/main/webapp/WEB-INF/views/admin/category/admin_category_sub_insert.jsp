        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<p class="mb-4">버캣컬리 상품의 중위 카테고리를 관리하는 페이지입니다.</p>
                   
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <h4 class="" style="color: #6406ca; font-weight: bolder; float: left; margin-top:10px;" >중위 카테고리 등록</h4>
                        </div>
                        <div class="card-body">
                           <form method="post" id ="form" role="form" action="${pageContext.request.contextPath}/admin_category_sub_insertDB.mdo" >
