...
<body id="page-top">
                ...
                <div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header">
		        			<h4 class="" style="color: #6406ca; font-weight: bolder; float: left; margin-top:10px;" >쿠폰 수정/삭제</h4>
		           		</div>
					<div class="card-body">
						<form id="form" action="${pageContext.request.contextPath}/updateCoupon.mdo" method="post" enctype="multipart/form-data">
					...
					<div id="buttondiv">
						...
						<a href="javascript:void(0);" onClick="fn_delete('${coupon.coupon_no}')" class="btn btn-danger btn-icon-split">
							<span class="icon text-white-50">
	...
	<script>
	function fn_delete(coupon_no) {
	  	  var result = confirm("이 쿠폰을 삭제하시겠습니까? ");
	      if(result){
	    	 	var url = "${pageContext.request.contextPath}/deleteCoupon.mdo";
	  			url = url + "?no=" + coupon_no;
	  			location.href = url;
	            alert("쿠폰이 삭제되었습니다.");
	      }else{
