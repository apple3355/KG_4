...
<head>
    ...
    <title>BucketKurly::Admin-CouponInsert</title>
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 style="color: #5f0080; font-weight: bolder;">쿠폰등록</h6> <!-- class="m-0 font-weight-bold text-warning" -->
			</div>
			<div class="card-body">
				<div class="table-responsive">

			<form action="/insertCoupon.mdo" method="post" enctype="multipart/form-data">
		<div class="container-fluid">
					<!-- 전체 frame -->
					<ul>						
						<!-- 제목 -->
					...
					<div align="right">
						<a href="admin_coupon_getList.mdo"  class="btn btn-light btn-icon-split">
