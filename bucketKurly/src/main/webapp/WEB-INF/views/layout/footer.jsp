...
<body>
	<div id="footer" style="opacity: 1;">	<!-- inner_footer / footer_link -->	
		...
		<div class="inner_footer">
			...
			<div class="footer_cc">
				...
				<div class="cc_view cc_kakao">
					<h3><a class="tit" href="##########">카카오톡 문의</a></h3>
					<dl class="list">
						<dt>365고객센터</dt>
						<dd>오전 7시 - 오후 7시</dd>
					</dl>
				...
				<div class="cc_view cc_qna">
					<h3>
						<a href="##############" onclick="#############" class="tit">1:1 문의</a>
					</h3>
					<dl class="list">
						<dt>24시간 접수 가능</dt>
			...
			<div class="company">
				...
				법인명 (상호) : 주식회사 버켓 <span class="bar">I</span> 사업자등록번호 : 123-45-67890
				<a href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=2618123567&amp;apv_perm_no=" target="_blank" class="link">사업자정보 확인</a> <br> 
				통신판매업 : 제 2018-서울강남-01646 호 <span class="bar">I</span> 개인정보보호책임자 : Bucket <br>
				주소 : 서울특별시 종로구 돈화문로 26 단성사 4층 <span class="bar">I</span> 대표이사 : Kurly <br> 
				입점문의 : <a href="https://forms.gle/oKMAe1SaicqMX3SC9" target="_blank" class="link">입점문의하기</a> <span class="bar">I</span>
				제휴문의 : <a href="mailto:business@kurlycorp.com" class="link">business@BucketKurly.com</a> <br> 
				채용문의 : <a href="mailto:recruit@kurlycorp.com" class="link">recruit@BucketKurly.com</a><br> 
				팩스: 070 - 1234 - 5678 <span class="bar">I</span> 
				이메일 : <a href="mailto:help@kurlycorp.com" class="link">help@BucketKurly.com</a><br> 
				대량주문 문의 : <a href="mailto:help@Kurlycorp.com" class="link">help@BucketKurly.com</a>
				...
				<ul class="list_sns">
					...
					<li>
						<a href="http://blog.naver.com/marketkurly" class="link_sns" target="_blank">
					...
					<li>
						<a href="https://m.post.naver.com/marketkurly" class="link_sns" target="_blank">
						 	<img src="https://res.kurly.com/pc/ico/1810/ico_naverpost.png" alt="마켓컬리 유튜브 바로가기">
						</a>
					</li>
					<li>
