...
<div id="wrap" class="">
   <div id="pos_scroll"></div>
   	<div id="container">
      <!-- header -->
      <%@ include file="/WEB-INF/views/member_main_header.jsp"%>  								
		<div id="main">
			<div id="content">
						...
						<div class="main_type1" >
   							<div class="list_goods">
        						<div id="bannerWrap" class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 370px; ">											
											...
											<ul data-section="main_banner" id="slideBanner" class="list"
												style="width:1515%; position: relative; transition-timing-function: ease-in-out; transition-duration: 0.5s; transform: translate3d(-2000px, 0px, 0px);">
									...
									<div class="list_goods">
										...
										<div class="bx-wrapper"
											...
											<div class="swiper-container">
												...
												<ul data-title="이 상품 어때요?" class="swiper-wrapper"
													...
													<li data-index="1" class="swiper-slide"
														...
														<div class="info_goods">
															...
															</span> <span class="cost">2,300원</span>
														</div></li>
													...
													<li data-index="2" class="swiper-slide"
														...
														<div class="info_goods">
															<span class="name"><a class="txt">닭가슴살 200g</a></span> <span
																class="price"><span class="dc">5%</span>3,090원 </span> <span
																class="cost">6,980원</span>
														</div></li>
														
													<li data-index="3" class="swiper-slide" class="cut"
														data-name="today_recommendation"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
													...
													<li data-index="4" class="swiper-slide"
														...
														<div class="info_goods">
															<span class="name"><a class="txt">비트</a></span> <span class="price"><span
																class="dc">20%</span>4,590원 </span> <span class="cost">7,000원</span>
														</div></li>
													...
													<li data-index="6" class="swiper-slide" class="cut"
														data-name="today_recommendation"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;">
														<a class="thumb_goods">
														  <span class="global_sticker">
													...
													<li data-index="9" class="swiper-slide" class="cut"
														data-name="today_recommendation"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;">
														<a class="thumb_goods">
														  <span class="global_sticker">
													...
													<li data-index="12" class="swiper-slide" class="cut"
														data-name="today_recommendation"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
													...
													<li data-index="15" class="swiper-slide" class="cut"
														data-name="today_recommendation"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
													...
													<li data-index="18" class="swiper-slide"class="cut"
														data-name="today_recommendation"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;">
														<a class="thumb_goods">
														  <span class="global_sticker">
        									...
        									<div id="nextBtn2" class="swiper-button-next"></div>
        									<div id="prevBtn2" class="swiper-button-prev"></div>
        									-->
									...
									<div class="list_goods">
										<div class="bx-wrapper"
											...
											<div class="bx-viewport"
												...
												<ul data-title="놓치면 후회할 가격" data-section="theme_goods_20" class="swiper-wrapper"
													class="list"
													style="width: 815%; position: relative; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
													
													<li data-index="1" class="swiper-slide" data-name="theme_goods_20"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
															src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAG0AAACRCAQAAABjof6/AAAANUlEQVR4Ae3BgQAAAADDoPtTT+AI1QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIAnfAsAAe7+tYwAAAAASUVORK5CYII="
													...
													<li data-index="2" class="swiper-slide" data-name="theme_goods_20"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;">
														<a class="thumb_goods">
														  <span class="global_sticker">
														    <span class="inner_sticker">
													...
													<li data-index="3" class="swiper-slide" class="cut" data-name="theme_goods_20"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
															src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAG0AAACRCAQAAABjof6/AAAANUlEQVR4Ae3BgQAAAADDoPtTT+AI1QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIAnfAsAAe7+tYwAAAAASUVORK5CYII="
													...
													<li data-index="4" class="swiper-slide" data-name="theme_goods_20"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
															src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAG0AAACRCAQAAABjof6/AAAANUlEQVR4Ae3BgQAAAADDoPtTT+AI1QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIAnfAsAAe7+tYwAAAAASUVORK5CYII="
													...
													<li data-index="5" class="swiper-slide" data-name="theme_goods_20"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;"><a
														class="thumb_goods">
															<!----> <img
															src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAG0AAACRCAQAAABjof6/AAAANUlEQVR4Ae3BgQAAAADDoPtTT+AI1QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIAnfAsAAe7+tYwAAAAASUVORK5CYII="
													...
													<li data-index="6" class="swiper-slide"  class="cut" data-name="theme_goods_20"
														style="float: left; list-style: none; position: relative; width: 249px; margin-right: 18px;">
														<a class="thumb_goods">
														  <span class="global_sticker">
														    <span class="inner_sticker">
