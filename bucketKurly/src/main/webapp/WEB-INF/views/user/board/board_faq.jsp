				...
				<div id="content" >					
					...
					<div class="page_aticle aticle_type2">
						<div id="snb" class="snb_cc">
							...
							<div class="inner_snb">							
								<ul class="list_menu"  >								   
									<li class="on"><a href="${pageContext.request.contextPath}/board_notice.do" class="board_notice">공지사항</a><br></li>
					...
					<script type="text/javascript">
		               //맨 앞 페이지 버튼 이벤트
		                function fn_first() {
		                  var page = 1;
		                  var range = 1;
		                  var url = "${pageContext.request.contextPath}/board_faq.do";
		                  url = url + "?page=" + page;
		                  url = url + "&range=" + range;
		                  location.href = url;
		               }
