										...
										<tbody>
											<tr>
												...
												<td>
													...
													<input type="text" name="board_qna_title" style="width:100%" label="제목" value="<c:out value="${board_qnaVO.board_qna_title}"/>" >
												</td>
											</tr>
											<tr>
												<th class="input_txt">주문번호</th>
												<td>
													<input type="text" name="board_qna_order_no" style="width:25%" value="<c:out value="${board_qnaVO.board_qna_order_no}"/>" readonly="readonly" onclick="$(this).blur()" onfocus="$(this).blur()">
											...
											<tr>
												...
												<td>
													<input type="text" name="board_qna_email" value="<c:out value="${board_qnaVO.board_qna_email}"/>" size="26" readonly="readonly" class="read_only">
											...
											<tr>
												...
												<td>
													<input type="text" name="board_qna_phone" value="<c:out value="${board_qnaVO.board_qna_phone}"/>"  readonly="readonly" class="read_only">
