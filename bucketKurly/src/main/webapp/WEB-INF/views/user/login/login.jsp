						...
						<div class="write_form">
							<div class="write_view login_view">
								<form method="post" name="form" id="form"onsubmit="return checkReCaptcha();"action="${pageContext.request.contextPath}/chklogin.do">
									...
									<input type="text" name="member_id" size="20" tabindex="1" value=""placeholder="아이디를 입력해주세요"> 
								...
								<a href="${pageContext.request.contextPath}/join.do" class="btn_type2 btn_member">
